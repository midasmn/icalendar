...
$dd = date('d');
 ...
 //画像取得
//$get_url = 'http://www.amazon.co.jp/gp/bestsellers/books/'; //アマゾンコミックベストセラー
...
$rtn_array = array();
//クーロン対象で未処理＆表示対象ON
// $sql = 'SELECT `url`, `node`, `description`, `calendar_id` FROM `tbl_amazon` WHERE `cronflg` = "OFF" and `onflg` = "ON" limit 20;';
